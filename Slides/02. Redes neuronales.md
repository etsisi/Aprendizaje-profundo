...
## Notebook: [02. Métricas para problemas de clasificación y regresión.ipynb](https://etsisi.github.io/Aprendizaje-profundo/Notebooks/02.%20Perceptrón%20simple%20y%20perceptrón%20multicapa.ipynb)
...
## Notebook: [Métricas para problemas de clasificación y regresión.ipynb](https://etsisi.github.io/Aprendizaje-profundo/Notebooks/02.%20Métricas%20para%20problemas%20de%20clasificación%20y%20regresión.ipynb)
...
\begin{frame}[fragile]{Regularización: Batch Normalization}

El \alert{Batch Normalization} añade una capa extra, habitualmente entre las neuronas y la función de activación, con la idea de normalizar los valores de salida. 
...
\alert{Cuidado: }No siempre beneficia a nuestra red, hay estudios que postulan que el uso de esta técnica potencia que aparezcan problemas de \textbf{vanishin gradient}.

\end{frame}

\begin{frame}[fragile]{Regularización: Data Augmentation}

El Data Augmentation no está definido por un algoritmo concreto, sino más bien una \alert{estrategia}.

Se trata de aumentar de forma sintetica los datos de nuestro dataset.

Los métodos más comunes para dataset de imágenes son:
\begin{itemize}
    \item Voltear la imagen en horizontal / vertical
    \item Rotar la imagen X grados.
    \item Recortar, añadir relleno, redimensionar, …
    \item Introducir ruido, defectos, …
\end{itemize}
 Actualmente existen nuevos modelos de DL se pueden utilizar redes neuronales capaces de generar datos sintéticos para aumentar el dataset.
\end{frame}
