...
![](./images/rnn-sru-representation.png)
</center>
<figcaption>
<b>Figura 6</b>. Las dos representaciones ípicas de una SRU, normal (izquierda) y desplegada o <i>unrolled</i> (derecha).
</figcaption>

Ambas son equivalentes, se usan indistintamente

- Generalmente se prefiere usar la <i>unrolled</i> para facilitar la comprensión
...
![](./images/rnn-sru.png)
<figcaption>
<b>Figura 7</b>. Representación desplegada de una SRU
</figcaption>
</center>
</div>
<div class="column">
...
¡Por supuesto! De hecho es el mismo concepto que el de las <i>rolling windows</i>

<div class="columns">
<div class="column">
<center>

![](./images/rnn-overlapping-sliding-windows-01.png)
</center>
</div>
<div class="column">
<center>

![](./images/rnn-overlapping-sliding-windows-02.png)
</center>
</div>
</div>
<figcaption>
<b>Figura 9</b>. Al conjunto de datos se le llama <i>overlapping windows dataset</i>
</figcaption>
...
![](./images/rnn-problem-types-one-to-many.png)
</center>
<figcaption>
<b>Figura 10</b> Ilustración de la arquitectura <i>one-to-many</i>.
</figcaption>
...
![](./images/rnn-problem-types-many-to-one.png)
</center>
<figcaption>
<b>Figura 11</b> Ilustración de la arquitectura <i>many-to-one</i>.
</figcaption>
...
![](./images/rnn-problem-types-many-to-one-maxpool.png)
</center>
<figcaption>
<b>Figura 12</b> Ilustración de la arquitectura <i>many-to-one</i> usando <i>max pooling</i> para determinar la salida.
</figcaption>
...
![](./images/rnn-problem-types-many-to-many-same.png)
</center>
<figcaption>
<b>Figura 13</b> Ilustración de la arquitectura <i>many-to-many</i> con mismo tamaño de entrada-salida.
</figcaption>
...
![](./images/rnn-problem-types-many-to-many-different.png)
</center>
<figcaption>
<b>Figura 14</b> Ilustración de la arquitectura <i>many-to-many</i> con (potencial) diferente tamaño de entrada-salida.
</figcaption>
...
<figcaption>
<b>Figura 15</b> Diferentes problemas en redes neuronales recurrentes. Autor: Andrej Karpathy<sup>6</sup>.
</figcaption>
...
![](./images/rnn-movimiento.png)
</center>
<figcaption>
<b>Figura 16</b> ¿Hacia dónde se mueven la cabeza y la pelota?.
</figcaption>
...
![w:550](./images/rnn-secuencia-movimiento.jpg)
</center>
<figcaption>
<b>Figura 17</b> Los eventos pasados añaden información y contexto.
</figcaption>
...
Ambas técnicas son complementarias $\rightarrow$ Redes de convolución recurrentes (CRNN):

- Etiquetado de vídeos, reconocimiento de gestos, <i>sentiment analysis</i> en lenguas [logográficas](https://es.wikipedia.org/wiki/Logograma), ...
...
<cite>
"He residido en <strong>España</strong> los últimos 10 años, durante los cuales he visitado gran parte del país y disfrutado de su gastronomía. Puedo hablar con bastante fluidez el ...
</cite>
...
![w:333](./images/rnn-lstm-full.png)
</center>
<figcaption>
<b>Figura 17</b> Los eventos pasados añaden información y contexto.
</figcaption>
...
![w:333](./images/rnn-lstm-01.png)
</center>
<figcaption>

<b>Figura 18</b> <i>Forget gate layer</i>.
</figcaption>
</div>
<div class="column">
...
![w:333](./images/rnn-lstm-02.png)
</center>
<figcaption>

<b>Figura 19</b> <i>Input gate layer</i>.
</figcaption>
</div>
<div class="column">
...
![w:333](./images/rnn-lstm-03.png)
</center>
<figcaption>

<b>Figura 20</b> <i>Actualización del estado</i>.
</figcaption>
</div>
<div class="column">
...
![w:333](./images/rnn-lstm-04.png)
</center>
<figcaption>

<b>Figura 21</b> <i>Actualización del estado</i>.
</figcaption>
</div>
<div class="column">
...
![SRU, LSTM y GRU](./images/rnn-gru-full.png)
</center>
<figcaption>

<b>Figura 22</b> <i>Esquema de una unidad recurrente GRU</i>.
</figcaption>
</div>
<div class="column">
...
![asd](./images/rnn_lstm_gru.png)
</center>
<figcaption>
<b>Figura 23</b> <i>Comparativa de los diferentes modelos de redes recurrentes</i>.
</figcaption>
